...
# return_values = True if perturbation_arguments.args.method == "attn_norm" else False
...
# Source: https://github.com/gorokoba560/norm-analysis-of-transformer
...
class BertSelfAttention(nn.Module):
    ...
    def save_compute_scores(self, query_layer, key_layer):
        self.Q = query_layer.detach().data
        self.K = key_layer.detach().data

    def get_compute_scores(self):
        return self.Q, self.K, self.attention_head_size
    ...
    def forward(
        ...
        # self.save_compute_scores(query_layer, key_layer)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        # print("BertPooler",sequence_output.shape, pooled_output.shape)
